---
title: "UNICEF REPORT"
subtitle: "**<span style='color: #1F407A;'>When Hope Fades:</span>** *<span style='color: #1F77B4;'>The Story of Najir</span>*"
jupyter: python3
format:
  html:
...
<br><br>
According to the **_2021_** data, diarrhoea accounted for <span style="color:#1F407A;">**9% of all deaths in children under 5**</span> - over 1,200 daily, or 440,000 annually.
<br>
...
<p>The visualization's strength lies in its <span style="color: #1F407A; font-style: italic;">mosaic composition</span>: each bar is divided into colored segments corresponding to <strong>different regions</strong>, as shown in the provided legend. The structure simultaneously reveals three key insights:</p>
...
<p>My mother isn't just worried about me, but also about my sisters. In fact, it's not only <span style="color: #1F407A; font-weight: bold; font-style: italic;">boys</span> like me who suffer, but also <span style="color: #CC4178; font-weight: bold; font-style: italic;">girls</span> my same age.</p>
...
However, the <span style="color:#1F407A; font-weight:bold;">percentage of healthcare facilities with
...
<h1><strong><span style="color:#1F407A;">Birth Rate Trends</span><span style="color:#1F77B4;">: High vs Low Rate Countries</span></strong></h1>
...
<p><strong>Saving children from preventable deaths like diarrhoea requires <span style="background-color:#D6EEFF;">better healthcare access</span> and <span style="background-color:#D6EEFF;">hygiene in vulnerable communities</span>. Your <span style="background-color:#D6EEFF;">UNICEF donation</span> can <span style="background-color:#D6EEFF;">save lives</span> and <span style="background-color:#D6EEFF;">keep hope alive</span> for those still fighting.</strong></p>
